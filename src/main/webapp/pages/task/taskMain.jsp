...
<div id="masthead">
    ...
    <div id="globalNav"> <img alt="" src="../images/gblnav_left.gif" height="32" width="4" id="gnl" /> <img alt="" src="../images/glbnav_right.gif" height="32" width="4" id="gnr" />
        <div id="globalLink">
            <a href="/online/${user.userCode}/mainPage" id="gl1" class="glink">首页</a>
    ...
    <div id="pagecell1">
        ...
        <!--当前页面位置，待修改-->
        <div id="pageName"><h2>任务管理</h2><img alt="small logo" src="" height="59" width="66"/> </div>
        <div id="pageNav">

            <div id="sectionLinks"> <a href="####" onlick="addTask()">添加任务</a> <a href="####" onlick="allTask()">所有任务</a> <a href="####" onclick="updateTask()">任务完成更新</a> <a href="####" onclick="yesterdayReport()">昨日任务报告</a></div>
            <!--子目录，待修改
